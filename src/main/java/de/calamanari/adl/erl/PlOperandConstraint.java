...
/**
 * Operand constraints for validation define if a given operator is applicable to an operator.
 * 
...
public enum PlOperandConstraint {
    ...
    /**
     * @return error message explaining the incompatibility
     */
    ...
    /**
     * @return true if this operator needs a list of operands
     */
    public boolean isListOperandRequired() {
        return listOperandRequired;
    }

    private PlOperandConstraint(boolean requiresListOperand, String message) {
        this.message = message;
        this.listOperandRequired = requiresListOperand;
    }
